     ...
     return (
          <div className='h-dvh bg-zinc-900'>
               <div className='container h-full flex flex-col justify-center text-center' >
                    ...
                    <h1 className="py-5 text-3xl md:text-4xl font-semibold" data-aos="zoom-in-up" data-aos-delay={350}>Front-end developer</h1>
                    <p className='px-4 md:px-[20%] lg:px-[25%] antialiased opacity-85' data-aos="zoom-in-up" data-aos-delay={550}>
